...
; * Descrição: Este programa ilustra o funcionamento simultâneo entre um programa
; *            principal e interrupções. O programa principal faz contar os displays.
; *            As interrupções animam as barras que caem no ecrã.
; *            A temporização dos displays é feita por uma rotina com um ciclo de atraso.
; *            As temporizações do movimento das barras são feitas por interrupções. 
; *
; *********************************************************************************
