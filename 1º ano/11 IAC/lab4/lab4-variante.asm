...
; *
; * Nota: Igual a lab4-rotinas.asm mas usando uma única rotina para escrever nos 
...
; Argumentos: R1 - número (entre 0 e FFs doisH) a escrever no displays hexadecimais
;
; **********************************************************************
hexa_display:
