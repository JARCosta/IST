...
; *
; * ATENÇÃO - Tem de se substituir as contantes definidas com "????H"
...
INPUT   EQU ????H   ; endereço do porto de entrada (bit 0 = RTC; bit 1 = botão)
OUTPUT  EQU ????H   ; endereço do porto de saída
