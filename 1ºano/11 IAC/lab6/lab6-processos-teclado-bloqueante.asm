...
; *            com o erro de que um dos processos é bloqueante.
; *            Igual ao lab6-processos-barras-displays-OK.asm, com a adição de um processo
...
DELAY               EQU  8H        ; valor usado para implementar um atraso temporal    
